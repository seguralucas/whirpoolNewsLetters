...
public class ConstantesGenerales {
	 ...
	 public static String PATH_FIBERWS_PROPIEDADES/*=PATH_EJECUCION+"/Configuracion/configuracion.properties"*/;
	 ...
	 static{		 
		 try {
		    ...
		    PATH_FIBERWS_PROPIEDADES=PATH_EJECUCION+"Configuracion/FiberWS.properties";	
