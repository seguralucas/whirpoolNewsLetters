<%@page import="fiber.externalapis.UtilsJson"%>
<%@page import="fiber.externalapis.HandlerExternalApis"%>
<%@page import="fiber.externalapis.HandlerProducto"%>
<%@page import="fiber.externalapis.HandlerInteralApis"%>
<%@page import="fiber.newsletter.entidades.Respuesta"%>
...
~							<%
							out.write("<div class=\"errorMensaje\">Error en el proceso de b&uacute;squeda/inserci&oacute;n de sucursales</div>");
						}
					}
				}
			}
		...
		if(r.getDatosRespuesta()!=null){
			...
			for(int i=0; i<jsonArr.size();i++){
				json=(JSONObject)jsonArr.get(i); 
					out.write("<div class=\"infoSucursal\"><div class=\"sucursalProductDesc\">"+json.get("ProductDesc")+"</div> <div class=\"sucursalClass\">"+json.get("Class")+"</div> <div class=\"sucursalEquipment\""+json.get("Equipment")+"</div> (id:"+json.get("ProductId")+") <a class=\"linkSucursal\" href=\""+request.getRequestURL()+"?idProd="+json.get("ProductId")+"\">Ver detalle</a></div>");
			}
		}
		else{
